...
main_application.title('Alauddin Developed This Text Editor')
...
#### ---- Help-----####
help_vpad = tk.Menu(main_menu, tearoff=False)
...
main_menu.add_cascade(label='Help', menu=help_vpad)
...
def align_center():
    text_content = text_editor.get(1.0, 'end')
    text_editor.tag_config('centertext', justify=tk.CENTER)
    text_editor.delete(1.0, tk.END)
    text_editor.insert(tk.INSERT, text_content, 'centertext')
...
def align_right():
    text_content = text_editor.get(1.0, 'end')
    text_editor.tag_config('rightext', justify=tk.RIGHT)
    text_editor.delete(1.0, tk.END)
    text_editor.insert(tk.INSERT, text_content, 'rightext')
...
def changed(event=None):
    ...
    if text_editor.edit_modified():
        ...
        status_bar.config(text=f'Hi Success Point College, your CHARACTERS are : {characters} and WORDS are : {words}')
